...
python stereo_camera_calibrate/printImgListRight.py $(( NUMIMG / 1 )) > stereo_camera_calibrate/pyimglist.txt
...
echo "./stereo_calibrate pyimglist.txt 9 6 0.068 R"
./stereo_calibrate pyimglist.txt 9 6 0.068 R
