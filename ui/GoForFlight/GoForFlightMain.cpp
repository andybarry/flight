...
GoForFlightFrame::GoForFlightFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, id, _("Go For Flight"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE, _T("id"));
    ...
    BoxSizer2->Add(BoxSizer3, 4, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    BoxSizer2->Add(49,20,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
