...
fpga_sync_frame_number = 100;

dir = '2014-10-10-fpga-flight1/mat/';
...
[~, min_index] = min(abs(fpga.plane_time(fpga_sync_frame_number) - imu.utime));

time_diff_in_us = fpga.plane_time(fpga_sync_frame_number) - imu.utime(min_index);
...
fpga.logtime = fpga.time_us * 1e-6 + logtime_at_time_us_one - fpga.time_us(fpga_sync_frame_number)*1e-6;
